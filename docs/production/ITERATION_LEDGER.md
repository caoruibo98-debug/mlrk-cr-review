...
| 12 | pending | planned | Can external tool outputs be imported and scored case-by-case? | Not started. | Needs BioTransformer/MicrobeRX/GutBug output mappers and side-by-side recall metrics. |
