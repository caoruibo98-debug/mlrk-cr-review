...
| 09 | pending | planned | Can candidate generation recover first-wave products for challenge families without changing the scoring rubric? | Not started. | Needs controlled rule/rescue layer for hydroxycinnamate reduction, isoflavone reduction, gallate decarboxylation, and conservative hydrolysis. |
| 10 | pending | planned | Can external tool inputs be exported reproducibly? | Not started. | Needs BioTransformer/MicrobeRX/GutBug-compatible exports. |
